                        ...
                        <div class="row q-pa-md q-col-gutter-y-md">     
                            ...
                            <div class="col-12">
                                <q-select 
                                    ...
                                    :display-value="`${sub_category_selected ? sub_category_selected.label : ''}`"
                                />
                            </div>
                            <div class="q-pt-md">                
                                <q-btn 
                    ...
                    <div class="row shadow-2 ">
                        <div class="col-12">
                            <q-scroll-area style="height: 480px;">
                                <div 
                                    class="row shadow-2 q-ma-md q-pa-md" 
...
export default {
    ...
    methods: {
        ...
        validateFile (file) {
            ...
            if (file.size > MAX_SIZE) return `Max size ${MAX_SIZE/1000}Kb`
            if (!allowedTypes.includes(file.type)) return 'Not an image'
            return
        },
        getCategoryOptions() {
            this.axios.get('http://localhost:5000/categories/category_dropdown')
            .then(res => this.category_options = res.data)
        },
        getSubCategoryOptions() {
            ...
            .then(res => this.sub_category_options = res.data)
        },
    },
    mounted() {
