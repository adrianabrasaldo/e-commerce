      ...
      <div class="row wrap q-gutter-md flex-center">        
        <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
          <q-card class="my-card">
            <q-card-section>
              <div class="text-subtitle1 text-weight-bold">Product Sold</div>
            </q-card-section>
            <q-separator/>
            ...
            >
              <q-card-section>
                <span class="text-weight-bold">{{ this.productSold }}</span> out of your 
                <span class="text-weight-bold">{{ this.productRemain }}</span> products has been sold
              </q-card-section>
            </q-expansion-item>
          </q-card>
        </div>
