<template>
  <div class="q-mt-lg q-mb-lg">    
    <div class="shadow-1 q-pa-lg">
      <div class="text-h6 text-weight-bold">Overall Rating</div>
      <div class="row wrap items-center">
        <div class="col-xs-12 col-md-4 col-lg-4">
          <div>                     
            <span class="text-h2">{{ isNaN(overall_rating)? "0": overall_rating }}</span><span class="text-h4">/5</span>
          </div>
          <q-rating
    ...
    <div class="shadow-2 q-pa-md">
      <span v-if="review_list_length != 0" class="text-h6 text-weight-bold">Product Ratings & Preview</span>
      <div v-else class="text-heading text-weight-bold text-center">
        <q-icon name="mood" style="font-size: 40px;" />
        <div>
    ...
    <q-list bordered class="shadow-1 q-pa-xs" v-for="review in review_list" :key="review.id">
